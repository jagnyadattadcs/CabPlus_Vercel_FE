...
// LocationSearch component (same as in Hero.js)
        ...
        <AnimatePresence>
          {showSuccessPopup && (
            <motion.div
              ...
              exit={{ opacity: 0, y: -20, scale: 0.8 }}
              transition={{ duration: 0.5, type: "spring", stiffness: 300 }}
              className="w-full my-2 bg-gradient-to-r from-green-400 to-green-600
                 text-white px-5 py-4 rounded-xl shadow-2xl z-50
                 flex items-center gap-2 border-2 border-white/30"
            >
              <span className="w-5 h-5 bg-white rounded-full flex justify-center items-center text-green-600 font-bold animate-bounce">
                ✓
